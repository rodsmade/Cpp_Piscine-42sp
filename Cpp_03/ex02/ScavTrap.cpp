...
ScavTrap::ScavTrap() : ClapTrap() {
    ...
    std::cout << LIGHT_CYAN "ScavTrap" RESET "'s default constructor called." << std::endl;
};
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name) {
    ...
    this->_energyPoints = ScavTrap::DEFAULT_ENERGY_POINTS;
    this->_attackDamage = ScavTrap::DEFAULT_ATTACK_DAMAGE;
    std::cout << LIGHT_CYAN "ScavTrap" RESET "'s name constructor called." << std::endl;
};

ScavTrap::~ScavTrap() {
    std::cout << LIGHT_CYAN "ScavTrap" RESET "'s default destructor called." << std::endl;
};
